...
if ( ! function_exists( 'cobble_tribe_events_get_css' ) ) {
	add_filter( 'cobble_filter_get_css', 'cobble_tribe_events_get_css', 10, 2 );
	function cobble_tribe_events_get_css( $css, $args ) {
