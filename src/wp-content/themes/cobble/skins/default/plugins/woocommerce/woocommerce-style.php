...
if ( ! function_exists( 'cobble_woocommerce_get_css' ) ) {
	add_filter( 'cobble_filter_get_css', 'cobble_woocommerce_get_css', 10, 2 );
	function cobble_woocommerce_get_css( $css, $args ) {
...
$fdir = cobble_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
