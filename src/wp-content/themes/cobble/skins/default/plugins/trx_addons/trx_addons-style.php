...
if ( ! function_exists( 'cobble_trx_addons_get_css' ) ) {
	add_filter( 'cobble_filter_get_css', 'cobble_trx_addons_get_css', 10, 2 );
	function cobble_trx_addons_get_css( $css, $args ) {
