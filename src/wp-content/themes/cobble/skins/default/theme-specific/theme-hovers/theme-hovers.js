...
jQuery( document ).on(
	'action.init_hidden_elements', function(e, cont) {
		...
		if (COBBLE_STORAGE['button_hover'] && COBBLE_STORAGE['button_hover'] != 'default') {
			jQuery(
				// Tag 'button'
				...
				// Theme tabs
				+ '.cobble_tabs .cobble_tabs_titles li a:not([class*="sc_button_hover_"]),'
				// More link
			...
			).addClass( 'sc_button_hover_just_init sc_button_hover_' + COBBLE_STORAGE['button_hover'] );

			// Add button's hover class if not based on :before or :after elements (like 'sc_button_hover_arrow')
			if (COBBLE_STORAGE['button_hover'] != 'arrow') {
				jQuery(
					// Form buttons
			...
			jQuery(
				...
				// Theme tabs
				+ '.cobble_tabs .cobble_tabs_titles li a:not([class*="sc_button_hover_style_"]),'
				// Tag cloud
			...
			).removeClass( 'sc_button_hover_' + COBBLE_STORAGE['button_hover'] );
