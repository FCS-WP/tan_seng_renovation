...
Please install and activate it before starting to use the theme Cobble.
...
Theme documentation is available on https://cobble.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Cobble is Fontello.
